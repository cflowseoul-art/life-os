...
import type { Position, BubbleContent } from "../adapter/types";
import type { AgentPhase } from "../adapter/types";
import { useAttentionStore } from "../adapter/stubs";
import { usePreferencesStore } from "../adapter/stubs";
...
import { truncateBubbleText } from "../adapter/stubs";
