...
import type { BossState, BubbleContent, Position } from "../adapter/types";
...
// Retained from source for reference; unused by the current renderer.
void 0;
export const _STATE_COLORS: Record<BossState, number> = {
  idle: 0x2d3748, // Gray
