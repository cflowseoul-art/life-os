...
import { performSoftReset, getHmrVersion } from "../adapter/stubs";
...
import { wireGameRuntime, unwireGameRuntime } from "../adapter/stubs";
import { useCompactionAnimation } from "../adapter/stubs";
import { useOfficeTextures } from "../adapter/useOfficeTextures";
import {
  CANVAS_WIDTH,
  CANVAS_HEIGHT,
  BACKGROUND_COLOR,
...
import { useNavigationStore } from "../adapter/stubs";
import { LOBBY_FLOOR_ID } from "../adapter/stubs";
